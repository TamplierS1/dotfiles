...
awful.util.tagnames = { "default", "dev" }
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey }, "p", function() awful.util.spawn("flameshot gui") end,
              {description = "Take a screenshot using flamehsot", group = "flameshot"}),
    -- Take a screenshot
